#   Various code expanded on exercises from the book 
#   "Statistics and data analysis by David Ruppert"
#   R Packages Used
#   zoo
...
# Standard errors for variance and sd
...
# stimated standard errors for correlation
...
# rolling mean and SD values: using rolling functions from zoo
class(returns.z)
colIds(returns.z)
start(returns.z)
end(returns.z)
...
# use qnorm to compute quantiles from a sN(0,1)
args(qnorm)
